...
public class AlumnosDto {
	...
	public AlumnosDto(Long idAlumno, String nombre, String apellidoPaterno, String apellidoMaterno) {
		super();
		this.idAlumno = idAlumno;
		this.nombre = nombre;
		this.apellidoPaterno = apellidoPaterno;
	...
	public AlumnosDto(Long idAlumno, String nombre, String apellidoPaterno) {
		super();
		this.idAlumno = idAlumno;
		this.nombre = nombre;
		this.apellidoPaterno = apellidoPaterno;
	...
	public AlumnosDto(Long idAlumno, String nombre) {
		super();
		this.idAlumno = idAlumno;
		this.nombre = nombre;
		this.apellidoPaterno = apellidoPaterno;
	...
	public AlumnosDto(Long idAlumno ) {
		super();
		this.idAlumno = idAlumno;
		this.nombre = nombre;
		this.apellidoPaterno = apellidoPaterno;
